...
if CVD_type == 1:
    ...
    dis_index = 0
word_suffix = [
'_P_labonlyG+global_con+nature_points%d_ori_%s_ssimori_%s_ssim_%s_dis_dim_%s_finetune'%(opt.points,opt.ori,opt.ssimori,opt.lambda_ssim, opt.dim),
'_D_labonlyG+global_con+nature_points%d_ori_%s_ssimori_%s_ssim_%s_dis_dim_%s_finetune'%(opt.points,opt.ori,opt.ssimori,opt.lambda_ssim, opt.dim),
